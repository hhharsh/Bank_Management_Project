...
import bank.Transfer.Back;
import bank.Transfer.LogOut;
import bank.UserLogin.LoginButton;
import bank.UserLogin.harshit;
...
public class ChangePass {
	...
	public ChangePass(String usrid)
	{
		this.usrid=usrid;
	...
	class Change implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			try {
				...
				String q="update banking set password='"+newpass+"' where password='"+oldpass+"' and id='"+usrid+"'";
