...
import bank.Withdrawl.Back;
import bank.Withdrawl.LogOut;
import bank.Withdrawl.Withdrawamount;

public class AWithdrawl {
...
amlb= new JLabel("Amount");
	...
	a.addActionListener(new AWithdrawamount());
...
jf.add(jp);
	...
	class AWithdrawamount implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent arg0) 
		{
			...
			try {
				...
				String q1="select * from banking where id="+ss+"";
				...
				if(r.next())
				{
					...
					{
						int t=b-w;
						String q2 ="update banking set balance = "+t+" where id="+ss+" ";
